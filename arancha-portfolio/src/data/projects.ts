export type Project = {
  ...
  feature_bold: string;
  feature_tags: string[];
  role_sections: { title: string; body: string; image: string }[];
  soft_skills: string[];
  hard_skills: string[];
...
export const projects: Project[] = [
  // ─── 01 ACTIB ──────────────────────────────────────────────────────────
  {
    ...
    index: '01 / 10',
    category: 'design',
    tags: ['Industrial Design', 'Wearable', 'Sports', 'UX/UI', 'Prototyping'],
    year: '2025',
    ...
    role_sections: [
      {
        ...
        body: 'I conducted comprehensive user research, including interviews with volleyball players and analysis of live match footage to understand the challenges setters face — such as wrist stability, finger positioning, and lack of real-time feedback. These insights shaped the design requirements and informed a series of user journeys and illustrated training scenarios. I also explored biomechanical behaviour during drills to inform sensor selection and placement, incorporating motion and strain sensors to accurately track wrist and finger movement. Through low- and mid-fidelity prototyping, I tested vibration placement, wrist supports, and fingertip design, allowing data-driven iteration and refinement of features critical for skill development.',
        image: '/images/projects/actib/role-1.jpg',
      },
      {
        title: 'Product & UI/UX design',
        body: "I designed the glove's ergonomic form using iterative CAD modelling, and materials testing to ensure a balance between performance and comfort. Features like structured support zones, moisture-wicking materials, open fingertip design, and articulation grooves were developed for high-precision training. The haptic feedback module was integrated into the glove just above the wrist joint, after testing several placements to ensure it delivered clear, unobtrusive cues. I also developed a customizable vibration system, allowing users to select different feedback intensities through interchangeable modules. In parallel, I designed the Actib app UI, which complements the glove by allowing athletes to set preferences, monitor performance, and track precision-based metrics.",
        image: '/images/projects/actib/role-2.jpg',
      },
      {
        title: 'Packaging design & rendering',
        body: 'To support portability and hygiene, I developed a modular system where the electronic components are removable for easy washing. I designed a compact, pentagon-shaped storage case based on user feedback, using tactile form for easy identification in cluttered gym bags. The case was rendered with high-fidelity visualizations and detailed CMF strategy, incorporating durable, lightweight materials like recycled ABS and molded EVA foam to enhance usability for athletes on the go.',
        image: '/images/projects/actib/role-3.jpg',
      },
    ],
  ...
  // ─── 02 ALL-INK ────────────────────────────────────────────────────────
  {
    ...
    index: '02 / 10',
    category: 'design',
    tags: ['Industrial Design', 'Sustainability', 'Systems Design', 'UX/UI', 'CAD'],
    year: '2023',
    ...
    info: 'Developed as part of a university group project for the Sustainable Design Engineering module in 2023. The brief required teams to identify key sustainability issues in a chosen product — in this case, ink cartridges — and propose, prototype, and evaluate a holistic solution addressing the product, its packaging, and surrounding systems.',
    ...
    feature_bold: 'THE MOST SEAMLESS AND **LOW-WASTE** PRINTING SOLUTION THAT MAKES SUSTAINABILITY **EFFORTLESS** FOR EVERY USER.',
    ...
    role_sections: [
      {
        ...
        image: '/images/projects/all-ink/role-1.jpg',
      },
      {
        title: 'CAD & app development',
        body: 'I co-developed detailed CAD models of the redesigned ink cartridge and the interlocking cap system, engineered for easy disassembly and refilling, and the design for the ALL-INK delivery box, integrating protective materials sourced from recycled cartridges. On the digital side, I contributed to the layout and user experience of the ALL-INK mobile app, which allows users to subscribe, monitor ink levels, schedule deliveries, and track their environmental impact.',
        image: '/images/projects/all-ink/role-2.jpg',
      },
      {
        title: 'Sustainability analysis',
        body: 'I conducted a comprehensive lifecycle and CO₂ footprint analysis using tools such as Eco Audit to compare the ALL-INK solution with existing market options like Canon and The Recycling Factory. I evaluated the environmental impact of materials, manufacturing processes, transportation emissions, and end-of-life scenarios. This informed key product decisions, including the use of recycled materials, modular cartridge construction, and minimal packaging.',
        image: '/images/projects/all-ink/role-3.jpg',
      },
    ],
  ...
  // ─── 03 HIVE-FU ────────────────────────────────────────────────────────
  {
    ...
    index: '03 / 10',
    category: 'design',
    tags: ['Speculative Design', 'Healthcare', 'Space', 'CAD', 'User Research'],
    year: '2024–25',
    ...
    role_sections: [
      {
        ...
        image: '/images/projects/hive-fu/role-1.jpg',
      },
      {
        ...
        image: '/images/projects/hive-fu/role-2.jpg',
      },
      {
        ...
        image: '/images/projects/hive-fu/role-3.jpg',
      },
    ],
  ...
  // ─── 04 MARIO'S GARDEN ─────────────────────────────────────────────────
  {
    ...
    index: '04 / 10',
    category: 'design',
    tags: ['Education', 'Prototyping', 'Programming', 'Industrial Design'],
    year: '2023',
    ...
    role_sections: [
      {
        ...
        image: '/images/projects/marios-garden/role-1.jpg',
      },
      {
        ...
        image: '/images/projects/marios-garden/role-2.jpg',
      },
      {
        ...
        image: '/images/projects/marios-garden/role-3.jpg',
      },
    ],
  ...
  // ─── 05 NEST ASSURED ───────────────────────────────────────────────────
  {
    ...
    index: '05 / 10',
    category: 'design',
    tags: ['Industrial Design', 'Accessibility', 'CAD', 'Prototyping'],
    year: '2024',
    ...
    role_sections: [
      {
        ...
        image: '/images/projects/nest-assured/role-1.jpg',
      },
      {
        ...
        image: '/images/projects/nest-assured/role-2.jpg',
      },
      {
        title: 'Packaging design & rendering',
        ...
        image: '/images/projects/nest-assured/role-3.jpg',
      },
    ],
    soft_skills: ['User-centred Research & Design', 'Communication & Teamwork', 'Project Planning', 'Presenting'],
    hard_skills: ['Rapid Prototyping (Lo-fi & 3D Printing)', 'CAD & Renders (Fusion360, Keyshot)', 'Branding Positioning', 'Packaging Design', 'Industry Compliance'],
    tile_ratio: 'square',
    has_video: false,
  },
  ...
  // ─── 06 URSA ───────────────────────────────────────────────────────────
  {
    ...
    index: '06 / 10',
    category: 'design',
    tags: ['Wearable', 'Safety', 'Urban', 'UX/UI', 'User Research'],
    year: '2021',
    ...
    role_sections: [
      {
        ...
        image: '/images/projects/ursa/role-1.jpg',
      },
      {
        ...
        image: '/images/projects/ursa/role-2.jpg',
      },
      {
        ...
        image: '/images/projects/ursa/role-3.jpg',
      },
    ],
  ...
  // ─── 07 DESALINATION ───────────────────────────────────────────────────
  {
    ...
    index: '07 / 10',
    category: 'systems',
    tags: ['Sustainability', 'Systems Design', 'Engineering Analysis', 'Data Analysis'],
    year: '2024',
    ...
    role_sections: [
      {
        ...
        image: '/images/projects/desalination/role-1.jpg',
      },
      {
        title: '[PLACEHOLDER — Role section 2 title]',
        body: '[PLACEHOLDER — Role section 2 description]',
        image: '/images/projects/desalination/role-2.jpg',
      },
    ],
  ...
  // ─── 08 HOUSESCOUT ─────────────────────────────────────────────────────
  {
    ...
    index: '08 / 10',
    category: 'design',
    tags: ['UX/UI', 'User Research', 'Systems Design', 'Urban'],
    year: '2023',
    ...
    role_sections: [
      {
        title: '[PLACEHOLDER — Role section 1 title]',
        body: '[PLACEHOLDER — Role section 1 description]',
        image: '/images/projects/housescout/role-1.jpg',
      },
    ],
    soft_skills: ['[PLACEHOLDER]'],
    hard_skills: ['[PLACEHOLDER]'],
  ...
  // ─── 09 FOODJI ─────────────────────────────────────────────────────────
  {
    ...
    index: '09 / 10',
    category: 'design',
    tags: ['UX/UI', 'Sustainability', 'User Research', 'Prototyping'],
    year: '2022',
    course: '[PLACEHOLDER — Course name]',
    type: 'Group project',
    role: '[PLACEHOLDER — Role]',
    ...
    role_sections: [
      {
        title: '[PLACEHOLDER — Role section 1 title]',
        body: '[PLACEHOLDER — Role section 1 description]',
        image: '/images/projects/foodji/role-1.jpg',
      },
    ],
    soft_skills: ['[PLACEHOLDER]'],
    hard_skills: ['[PLACEHOLDER]'],
  ...
  // ─── 10 DATA TO PRODUCT ────────────────────────────────────────────────
  {
    ...
    index: '10 / 10',
    category: 'systems',
    tags: ['Data Science', 'Systems Design', 'UX/UI', 'Programming'],
    year: '2024',
    course: '[PLACEHOLDER — Course name]',
    ...
    role_sections: [
      {
        title: '[PLACEHOLDER — Role section 1 title]',
        body: '[PLACEHOLDER — Role section 1 description]',
        image: '/images/projects/data-to-product/role-1.jpg',
      },
    ],
    soft_skills: ['[PLACEHOLDER]'],
    hard_skills: ['[PLACEHOLDER]'],
...
export const otherProjects: OtherProject[] = [
  {
    ...
    tags: ['Systems Design', 'Data Analysis', 'Forecasting'],
    pdf_url: '/reports/drone-delivery.pdf',
  },
  {
    ...
    tags: ['Data Science', 'Programming', 'Data Analysis'],
    pdf_url: '/reports/rain-prediction.pdf',
  },
  {
    ...
    tags: ['Engineering Analysis', 'CAD'],
    pdf_url: '/reports/hip-implant-fea.pdf',
  },
];

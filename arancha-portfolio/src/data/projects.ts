...
export const projects: Project[] = [
  ...
  // ─── 04 OLIVE ──────────────────────────────────────────────────────────
  {
    ...
    features: ['Smart Plug Control', 'Boiler Integration', 'Curtailment Strategy', 'Community Value Dividend', 'Stakeholder Value-Exchange Model'],
    ...
    problem: "Orkney's wind fleet regularly produces enough electricity to cover 115% of local demand, yet subsea transmission limits force the grid to curtail around 25 GWh of that power every year, worth an estimated £2.5M in lost revenue. Meanwhile 63% of Orkney households live in fuel poverty, unable to afford the heat they need, a rate far above the Scottish average.",
...
export const otherProjects: OtherProject[] = [
  {
    ...
    type: 'Group project',
    role: 'Economic feasibility analysis & Monte Carlo simulation',
  ...
  },
  {
    ...
    type: 'Individual project',
    role: 'Finite element analysis & design optimisation',

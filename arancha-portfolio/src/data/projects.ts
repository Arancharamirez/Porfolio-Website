...
export const projects: Project[] = [
    ...
    // ─── 02 HOUSESCOUT ─────────────────────────────────────────────────────
  {
    ...
    info: "Founded by a team of six as a real operating startup for a university venture-creation module in 2026, complete with our own scout network, paid user acquisition, and a funding plan pitched against live financial modelling. Follow the build on Instagram at @get_housescout.",
    ...
    role_sections: [
      {
        ...
        images: [
          { src: '/images/projects/housescout/ui 1.png', caption: 'Renter job tracker with AI-flagged warnings' },
          { src: '/images/projects/housescout/ui 2.png', caption: 'Scout-side viewing and reporting flow' },
          { src: '/images/projects/housescout/ui 3.png', caption: 'Report detail and media review' },
        ],
      },
      {
        title: 'Validating the problem',
        body: "Before building, we grounded the concept in real renter pain points — unfiltered images, in-person representation, and total advocacy — validated through desk research on internal migration and international relocation trends. That research shaped both the product's three pillars and the honest, slightly cheeky brand voice ('Don't just hope for the best. Ensure it.') that runs through the whole platform.",
        images: [
          { src: '/images/projects/housescout/problem.png', caption: 'Renting remotely is a gamble' },
          { src: '/images/projects/housescout/solution.png', caption: 'Why scouts want to work with us' },
        ],
      },
      {
        ...
        images: [
          ...
          { src: '/images/projects/housescout/team.png', caption: 'The HouseScout founding team' },
        ],
      },
    ],
